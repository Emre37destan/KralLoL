...
public:
	static void Render()
	{
		if (ImGui::BeginTabItem("Bilgi"))
		{
			...
			ImGui::Text("Oyuncu adini girin:");
			ImGui::InputText("##inputPlayerName", playerName, IM_ARRAYSIZE(playerName));
			S.infoTab.playerName = playerName;
			ImGui::SameLine();

			if (ImGui::Button("Gonder##playerName") || ImGui::IsKeyPressed(ImGui::GetKeyIndex(ImGuiKey_Enter), false))
			{
			...
			ImGui::SameLine();
			if (ImGui::Button("Ben##playerName"))
			{
			...
			if (ImGui::Button("Lobiye Davet Et##infoTab"))
			{
			...
			ImGui::SameLine();
			if (ImGui::Button("Arkadaslara Davet Et##infoTab"))
			{
			...
			ImGui::SameLine();
			if (ImGui::Button("Engellenenler listesine ekle##infoTab"))
			{
			...
			if (ImGui::Button("Panoya kopyala##infoTab"))
			{
