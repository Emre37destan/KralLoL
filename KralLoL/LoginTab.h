...
private:
	...
	static void LoginOnClientOpen(std::string username, std::string password)
	{
		while (true)
		{
			...
			{
				// Ýstemcinin tamamen yüklendiðinden emin olmak için bekler
...
public:
	static void Render()
	{
		if (ImGui::BeginTabItem("Giris"))
		{
			...
			// Cfg dosyasýndan kaydedilmiþ dili bul
			...
			{
				// Dosya yoksa, ayrýþtýrýlabilmesi için {} ile yeni bir tane oluþturun
