...
public:
	static void Render()
	{
		if (ImGui::BeginTabItem("Ozel"))
		{
			...
			if (ImGui::CollapsingHeader("Ozel Baglanti Noktasi/Baslik"))
			{
				bCustom = true;
			...
			if (ImGui::Button("Ozel istek gonder##customTab"))
			{
			...
			ImGui::Text("Sonuc:");
			ImGui::SameLine();
			if (ImGui::Button("Panoya kopyala##customTab"))
			{
